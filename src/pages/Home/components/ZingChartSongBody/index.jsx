...
// components
import ZingChartSongBodyHeader from "../ZingChartSongBodyHeader";
import ZingChartSongBodyItems from "../ZingChartSongBodyItems";
...
export default function BodyZingChart() {
  ...
  return (
    <div className="body-zingchart">
      <ZingChartSongBodyHeader />
      <ul className="body-zingchart-list">
        {ListSong && ListSong.map((item) => <ZingChartSongBodyItems key={item.id} item={item} />)}
      </ul>
    </div>
  );
}
